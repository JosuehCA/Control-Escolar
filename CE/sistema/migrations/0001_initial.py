# Generated by Django 4.1.2 on 2024-10-28 06:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=100)),
                ('opcionesDePlatillo', models.ManyToManyField(related_name='menús', through='sistema.MenuPlatillo', to='sistema.platillo')),
            ],
        ),
        migrations.AddField(
            model_name='menuplatillo',
            name='menu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='opcionesMenu', to='sistema.menusemanal'),
        ),
        migrations.AddField(
            model_name='menuplatillo',
            name='platillo',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='sistema.platillo'),
        ),
        migrations.CreateModel(
            name='MensajePlantel',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fechaEnviado', models.DateTimeField(auto_now_add=True)),
                ('emisor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('grupos', models.ManyToManyField(related_name='mensajes', to='sistema.grupo')),
            ],
            options={
